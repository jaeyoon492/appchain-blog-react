...
export { Proposal, QueryProposalRequest, QueryParamsRequest, VotingParams, MsgVoteWeighted, TallyParams, QueryProposalResponse, QueryProposalsRequest, QueryVotesRequest, QueryDepositRequest, MsgSubmitProposalResponse, MsgVote, QueryVoteResponse, QueryParamsResponse, WeightedVoteOption, MsgVoteResponse, MsgVoteWeightedResponse, QueryVotesResponse, QueryTallyResultResponse, TallyResult, MsgDepositResponse, GenesisState, QueryDepositsRequest, QueryDepositsResponse, Deposit, MsgDeposit, TextProposal, QueryProposalsResponse, QueryVoteRequest, QueryTallyResultRequest, MsgSubmitProposal, QueryDepositResponse, Vote, DepositParams };
